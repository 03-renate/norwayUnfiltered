...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const dotsContainer = document.querySelector(".carousel-nav"); /* convert to array to ensure iteration */
...
function createDotTemplate(index) {
    return `<button class="carousel-nav ${index === 0 ? "active" : ""}"></button>`;
}
